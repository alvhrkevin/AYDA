...
<body class="theme-green">
    <!-- Top Bar -->
    <?php $page = 'ekspeminjam'; include "include/sidebar_display.php"; ?>
    <!-- #Top Bar -->
    <div id="sidebar">
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="header">
                ...
                <div class="text-right">
                    <button onclick="prt();" class="btn btn-secondary" id="print-btn"><i class="material-icons">local_printshop</i></button>
                </div>
            </div>
            <div class="body">
                <?php
        ...
        <div class="card">
            <div class="header">
                <h2>
                    <center>Fasilitas Property</center>
                </h2>
            </div>
            <div class="body">
                <?php
...
<script type="text/javascript">
    ...
    function prt() {
        var a = window.location.href.replace('cetak_dis', 'cetak_dis1');
